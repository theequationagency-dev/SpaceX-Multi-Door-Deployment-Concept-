...
- **3–4 independent deployment doors** distributed around the fuselage at different azimuths
- Each door has its own rail, actuator, and satellite staging shelf
...
| `SUBMISSION.md` | Submission log and record |
